...
export default function NewPasswordScreen() {
  ...
  const handleReset = async () => {
    if (!password || !confirm) { Alert.alert('Lỗi', 'Vui lòng điền đầy đủ các trường'); return; }
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <TextInput style={styles.input} value={password} onChangeText={setPassword} placeholder="••••••••" secureTextEntry placeholderTextColor={Colors.textHint} />
        <Text style={styles.label}>Xác nhận mật khẩu</Text>
        <TextInput style={styles.input} value={confirm} onChangeText={setConfirm} placeholder="••••••••" secureTextEntry placeholderTextColor={Colors.textHint} />
