      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.stepsCard}>
          ...
          {[
            ...
            { icon: 'checkmark-circle-outline', text: 'Kết nối thành công — người thân sẽ thấy dữ liệu sức khoẻ của bạn' },
          ].map((step, i) => (
            <View key={i} style={styles.stepRow}>
              <View style={styles.stepNum}>
                <Text style={styles.stepNumText}>{i + 1}</Text>
              </View>
              <Ionicons name={step.icon as keyof typeof Ionicons.glyphMap} size={20} color={Colors.primary} style={styles.stepIcon} />
...
const styles = StyleSheet.create({
  ...
  instructionText: { flex: 1, fontSize: 14, color: Colors.primary, lineHeight: 20, fontWeight: '500' },
  ...
  qrPlaceholder: { width: QR_SIZE, height: QR_SIZE, alignItems: 'center', justifyContent: 'center', gap: 16 },
